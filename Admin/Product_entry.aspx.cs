    ...
    protected void Button16_Click(object sender, EventArgs e)
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlCommand cmd = new SqlCommand("update product_entry set category_id='" + DropDownList4.SelectedItem.Value + 
                    "',subcategory_id='" + DropDownList6.SelectedItem.Value + 
                    "', category_name='" + DropDownList4.SelectedItem.Text + 
                    "',subcategory_name='" + DropDownList6.SelectedItem.Text + 
                    "', product_name='" + HttpUtility.HtmlDecode(TextBox16.Text) +
                    "' where code='" + Label29.Text + "'  and Com_Id='" + company_id + "' ", CON);
